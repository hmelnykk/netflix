...
export const initialFilm: FilmTemplate = {
    id: "0",
    name: "a",
    description: 'abc',
    category: 'a',
...
export const footerLinks = [
    ...
    ["Account", "Ways to Watch", "Corporate Information", "Only in Netflix"],
